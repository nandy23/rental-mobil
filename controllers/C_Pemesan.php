...
class C_Pemesan extends Controller
{
	...
	{
		if (!isset($id) || count($this->pemesan->cek($id)) == 0) redirect('pemesan');

		$data = [
			'aktif' => 'pemesan',
			'judul' => 'Detail Pemesan',
			'pemesan' => $this->pemesan->detail($id),
		];
	...
	public function hapus($id = null)
	{
		...
		$gambar	= $this->pemesan->detail($id)['foto'];
	...
	public function ubah($id)
	{
		...
		$data = [
			'aktif' => 'pemesan',
			'judul' => 'Ubah Pemesan',
			'pemesan' => $this->pemesan->lihat_id($id)
		];
	...
	{
		if (!isset($id) || count($this->pemesan->cek($id)) == 0 || !isset($_POST['ubah'])) redirect('pemesan');
