					...
					<div class="row">
						<div class="col-sm-6">
							<div class="card shadow">
								...
								<div class="card-body">
									<form method="POST" action="<?= base_url('mobil/proses_ubah/' . $mobil['id']) ?>" enctype="multipart/form-data">
										...
										<div class="form-group">
											...
											<input type="file" value="<?= $mobil['gambar'] ?>" name="gambar" id="gambar" required="required" placeholder="ketik" autocomplete="off" class="form-control-file">
										</div>
										<div class="form-group">
